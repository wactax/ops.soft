...
DROP TRIGGER IF EXISTS res_ver_down_trigger ON res_ver;
DROP INDEX IF EXISTS res_file_res_id_idx;
DROP INDEX IF EXISTS res_file_alias_val_idx;
ALTER TABLE IF EXISTS ONLY word_res_ver DROP CONSTRAINT IF EXISTS word_res_ver_word_id_res_ver_id_key;
ALTER TABLE IF EXISTS ONLY word_res_ver DROP CONSTRAINT IF EXISTS word_res_ver_pkey;
ALTER TABLE IF EXISTS ONLY word DROP CONSTRAINT IF EXISTS res_word_val_key;
ALTER TABLE IF EXISTS ONLY word DROP CONSTRAINT IF EXISTS res_word_pkey;
ALTER TABLE IF EXISTS ONLY res_ver DROP CONSTRAINT IF EXISTS res_ver_res_id_rid_key;
ALTER TABLE IF EXISTS ONLY res_ver DROP CONSTRAINT IF EXISTS res_ver_pkey;
ALTER TABLE IF EXISTS ONLY res DROP CONSTRAINT IF EXISTS res_pkey;
ALTER TABLE IF EXISTS ONLY res_file DROP CONSTRAINT IF EXISTS res_file_pkey;
ALTER TABLE IF EXISTS ONLY res_file_failed DROP CONSTRAINT IF EXISTS res_file_failed_pkey;
ALTER TABLE IF EXISTS ONLY res_file_downed DROP CONSTRAINT IF EXISTS res_file_downed_pkey;
ALTER TABLE IF EXISTS ONLY res DROP CONSTRAINT IF EXISTS res_cid_rid_key;
ALTER TABLE IF EXISTS ONLY res_file_alias DROP CONSTRAINT IF EXISTS res_alias_pkey;
ALTER TABLE IF EXISTS ONLY kind DROP CONSTRAINT IF EXISTS kind_pkey;
ALTER TABLE IF EXISTS ONLY ext DROP CONSTRAINT IF EXISTS ext_val_key;
ALTER TABLE IF EXISTS ONLY ext DROP CONSTRAINT IF EXISTS ext_pkey;
ALTER TABLE IF EXISTS word_res_ver ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS word ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS res_ver ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS res_file ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS res ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS kind ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS ext ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS word_res_ver_id_seq;
DROP TABLE IF EXISTS word_res_ver;
DROP SEQUENCE IF EXISTS res_word_id_seq;
DROP TABLE IF EXISTS word;
DROP SEQUENCE IF EXISTS res_ver_id_seq;
DROP TABLE IF EXISTS res_ver;
DROP SEQUENCE IF EXISTS res_id_seq;
DROP SEQUENCE IF EXISTS res_file_id_seq;
DROP TABLE IF EXISTS res_file_failed;
DROP TABLE IF EXISTS res_file_downed;
DROP TABLE IF EXISTS res_file_alias;
DROP TABLE IF EXISTS res_file;
DROP TABLE IF EXISTS res;
DROP SEQUENCE IF EXISTS kind_id_seq;
DROP TABLE IF EXISTS kind;
DROP SEQUENCE IF EXISTS ext_id_seq;
DROP TABLE IF EXISTS ext;
DROP FUNCTION IF EXISTS update_res_ver_down();
