...
DROP TRIGGER IF EXISTS trigger_civitai_img ON civitai_img;
DROP INDEX IF EXISTS "task.hash";
DROP INDEX IF EXISTS "task.cid.rid";
DROP INDEX IF EXISTS "meta.hash";
DROP INDEX IF EXISTS "civitai_img.url";
ALTER TABLE IF EXISTS ONLY task DROP CONSTRAINT IF EXISTS task_pkey;
ALTER TABLE IF EXISTS ONLY meta DROP CONSTRAINT IF EXISTS meta_pkey;
ALTER TABLE IF EXISTS ONLY meta DROP CONSTRAINT IF EXISTS meta_hash_key;
ALTER TABLE IF EXISTS ONLY civitai_user DROP CONSTRAINT IF EXISTS civitai_user_pkey;
ALTER TABLE IF EXISTS ONLY civitai_post DROP CONSTRAINT IF EXISTS civitai_review_pkey;
ALTER TABLE IF EXISTS ONLY civitai_img DROP CONSTRAINT IF EXISTS civitai_img_pkey;
ALTER TABLE IF EXISTS ONLY adult DROP CONSTRAINT IF EXISTS adult_pkey;
ALTER TABLE IF EXISTS ONLY adult_mc DROP CONSTRAINT IF EXISTS adult_mc_pkey;
ALTER TABLE IF EXISTS ONLY adult_hw DROP CONSTRAINT IF EXISTS adult_hw_pkey;
ALTER TABLE IF EXISTS ONLY adult_google DROP CONSTRAINT IF EXISTS adult_google_pkey;
ALTER TABLE IF EXISTS ONLY adult_deepai DROP CONSTRAINT IF EXISTS adult_deepai_pkey;
ALTER TABLE IF EXISTS ONLY adult_baidu DROP CONSTRAINT IF EXISTS adult_baidu_pkey;
ALTER TABLE IF EXISTS task ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS meta ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS task_id_seq;
DROP TABLE IF EXISTS task;
DROP SEQUENCE IF EXISTS meta_id_seq;
DROP TABLE IF EXISTS meta;
DROP TABLE IF EXISTS civitai_user;
DROP TABLE IF EXISTS civitai_post;
DROP TABLE IF EXISTS civitai_img;
DROP SEQUENCE IF EXISTS civitai_img_id_seq;
DROP TABLE IF EXISTS adult_mc;
DROP TABLE IF EXISTS adult_hw;
DROP TABLE IF EXISTS adult_google;
DROP TABLE IF EXISTS adult_deepai;
DROP TABLE IF EXISTS adult_baidu;
DROP TABLE IF EXISTS adult;
DROP FUNCTION IF EXISTS trigger_civitai_img();
