...
ALTER TABLE IF EXISTS ONLY miss DROP CONSTRAINT IF EXISTS miss_pkey;
ALTER TABLE IF EXISTS ONLY miss DROP CONSTRAINT IF EXISTS miss_kind_id_hash_key;
ALTER TABLE IF EXISTS ONLY kind DROP CONSTRAINT IF EXISTS kind_val_key;
ALTER TABLE IF EXISTS miss ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS kind ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS miss_id_seq;
