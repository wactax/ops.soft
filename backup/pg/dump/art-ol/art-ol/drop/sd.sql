...
ALTER TABLE IF EXISTS ONLY sd."user" DROP CONSTRAINT IF EXISTS user_pkey;
ALTER TABLE IF EXISTS ONLY sd."user" DROP CONSTRAINT IF EXISTS user_cid_rid_key;
ALTER TABLE IF EXISTS ONLY sd.checkpoint_ver DROP CONSTRAINT IF EXISTS checkpoint_ver_pkey;
ALTER TABLE IF EXISTS ONLY sd.checkpoint_ver_file DROP CONSTRAINT IF EXISTS checkpoint_ver_file_pkey;
ALTER TABLE IF EXISTS ONLY sd.checkpoint DROP CONSTRAINT IF EXISTS checkpoint_pkey;
ALTER TABLE IF EXISTS ONLY sd.checkpoint DROP CONSTRAINT IF EXISTS checkpoint_cid_rid_key;
ALTER TABLE IF EXISTS sd."user" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS sd.checkpoint_ver_file ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS sd.checkpoint_ver ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS sd.checkpoint ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS sd.user_id_seq;
DROP TABLE IF EXISTS sd."user";
DROP SEQUENCE IF EXISTS sd.checkpoint_ver_id_seq;
DROP SEQUENCE IF EXISTS sd.checkpoint_ver_file_id_seq;
DROP TABLE IF EXISTS sd.checkpoint_ver_file;
DROP TABLE IF EXISTS sd.checkpoint_ver;
DROP SEQUENCE IF EXISTS sd.checkpoint_id_seq;
DROP TABLE IF EXISTS sd.checkpoint;
